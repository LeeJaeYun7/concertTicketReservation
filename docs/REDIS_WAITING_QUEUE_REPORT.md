...
- 레디스 대기열은 **활성화열**과 짝을 이루며 작동합니다.
  대기열에 있는 대기 인원은 일정 주기마다 **활성화열로 이동**하게 되며, <br>
  **활성화열로 이동**한 인원은 그때부터 **티켓 예약**이 가능합니다.

- 레디스 대기열은 '활성화열'과 짝을 이룹니다. <br>
  즉, 대기열에 있는 대기 인원은 일정 주기마다 활성화열로 이동하고, <br>
  활성화열로 이동하게 되면, 그때부터 티켓 예약이 가능합니다. <br>
