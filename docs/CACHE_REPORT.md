...
A. 인터파크 티켓 사이트를 기준으로 요청 건수를 설정해봤습니다. <br> 
   ...
   또한, 유사한 사례인 배달의민족의 2019년 기준 MAU가 **800만 명**일 때, <br>
   RPM(Request Per Minute)은 **3000**이었던 자료를 참고했습니다. <br>
  
   따라서, 인터파크 티켓은 배달의민족에 비해 MAU가 약 1/8 수준이지만, **메인 페이지**임을 고려하여 요청 건수를 다음과 같이 계산했습니다 <br> 
   ![image](https://github.com/user-attachments/assets/d831eb09-1837-40bf-830c-a4e2631ee402) <br> 
   이를 바탕으로 **약 1000 RPM** 정도로 테스트하는 것이 적절하다고 판단했습니다. <br> 
