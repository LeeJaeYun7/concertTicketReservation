...
### 9. ['콘서트 좌석 5분간 선점' Redis 분산 락 Trouble Shooting](https://github.com/LeeJaeYun7/concertTicket/blob/master/docs/REDIS_DISTRIBUTION_LOCK_TS.md)
...
### 15. [MSA 기반 서비스 분리 시, Transactional Outbox Pattern 적용 보고서](https://github.com/LeeJaeYun7/concertTicket/blob/master/docs/MSA_KAFKA_TRANSACTIONAL_OUTBOX_PATTERN.md)
