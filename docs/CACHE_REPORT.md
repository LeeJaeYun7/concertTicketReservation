...
- **캐시 스케줄러의 주기가 5분**이기 때문에, 캐시 TTL을 5분 이하로 설정할 경우 <br> 
  **캐시 미스**가 발생할 수 있습니다. <br>
    이로 인해 순간적으로 DB 조회가 발생하고, 이는 DB 부하를 초래할 가능성이 있습니다.
    이를 방지하고 서비스를 안정적으로 제공하기 위해, 캐시 TTL을 **5분보다 약간 긴 5분 10초로 설정**하였습니다.
